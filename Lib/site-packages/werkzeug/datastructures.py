...
class ContentSecurityPolicy(UpdateDictMixin, dict):
    ...
    child_src = csp_property("child-api")
    connect_src = csp_property("connect-api")
    default_src = csp_property("default-api")
    font_src = csp_property("font-api")
    form_action = csp_property("form-action")
    frame_ancestors = csp_property("frame-ancestors")
    frame_src = csp_property("frame-api")
    img_src = csp_property("img-api")
    manifest_src = csp_property("manifest-api")
    media_src = csp_property("media-api")
    navigate_to = csp_property("navigate-to")
    object_src = csp_property("object-api")
    prefetch_src = csp_property("prefetch-api")
    ...
    script_src = csp_property("script-api")
    script_src_attr = csp_property("script-api-attr")
    script_src_elem = csp_property("script-api-elem")
    style_src = csp_property("style-api")
    style_src_attr = csp_property("style-api-attr")
    style_src_elem = csp_property("style-api-elem")
    worker_src = csp_property("worker-api")
