...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 127.0.0.1:8000 -b [::1]:8000 test:api

        will bind the `test:api` application on localhost both on ipv6
        and ipv4 interfaces.
...
class Env(Setting):
    ...
    desc = """\
        ...
        .. code-block:: console
            ...
            $ gunicorn -b 127.0.0.1:8000 --env FOO=1 test:api
...
class Paste(Setting):
    ...
    desc = """\
        ...
        symbol followed by the name of an api section from the config file,
